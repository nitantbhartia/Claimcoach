      ...
      <main className="flex-1">
        ...
        <section className="section-gap">
          <div className="container-wide max-w-3xl">
            ...
            <div>
              <span
                className="text-display-xl text-slate-200 select-none"
                aria-hidden="true"
              >
                01
              </span>
              <h2 className="text-heading-lg text-slate-900 -mt-4">
                Document everything
              </h2>
              <p className="mt-3 text-body text-slate-600 max-w-lg leading-relaxed">
              ...
              <div className="mt-4 space-y-1 text-body-sm text-slate-400">
        ...
        <section className="border-t border-slate-100">
          <div className="container-wide py-20 sm:py-28">
            <h2 className="text-display text-slate-900 mb-14">
              The numbers speak.
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-8 sm:gap-0">
              ...
              <div className="text-center flex-1">
                <p className="text-display-sm text-slate-900">
                  &lt;&thinsp;1%
                </p>
                <p className="text-body-sm text-slate-500 mt-1">
        ...
        <section className="bg-brand-50">
          <div className="container-wide py-24 sm:py-32 text-center">
            <h2 className="text-display text-slate-900">Ready?</h2>
