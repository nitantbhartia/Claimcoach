...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-paper-white">
        <div className="w-full max-w-sm text-center">
          <div className="mb-6">
            <Link href="/" className="inline-block mb-6">
              <span className="text-heading-lg font-serif font-bold">
                <span className="text-ink-800">Claim</span>
                <span className="text-ink-500">Coach</span>
              </span>
            </Link>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-paper">
            <h2 className="font-serif text-heading-md text-ink-800 mb-2">Check your email</h2>
            <p className="text-body-sm text-slate-500">
              We&apos;ve sent a confirmation link to <strong className="text-ink-800">{email}</strong>.
              Click the link to activate your account.
            </p>
          </div>
          <p className="text-body-sm text-slate-500 mt-6">
            Already confirmed?{" "}
            <Link href="/login" className="text-ink-800 font-medium hover:text-ink-900">
              Log in
            </Link>
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen flex bg-paper-white">
      {/* Left: Trust sidebar (desktop only) */}
      <div className="hidden lg:flex lg:w-[420px] bg-ink-800 text-white flex-col justify-between p-10">
        <div>
          <Link href="/">
            <span className="text-xl font-serif font-bold text-white">
              Claim<span className="text-white/60">Coach</span>
            </span>
          </Link>
        </div>

        <div className="space-y-8">
          <h2 className="font-serif text-heading-lg text-white leading-snug">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="font-serif text-heading-lg text-ink-800">Create your account</h1>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-paper-white px-3 text-caption text-slate-400">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button type="submit" loading={loading} className="w-full bg-ink-800 hover:bg-ink-900">
              Create account
            </Button>
          </form>
